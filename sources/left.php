...
<?php  
    // $nav_dmsp = $d->o_fet("select * from #_category where hien_thi=1 and module=3 and id_loai=251 order by so_thu_tu asc, id desc");  SẢN PHẨM
    $nav_dmsp = $d->o_fet("select * from #_category where hien_thi=1 and id_loai=463 order by so_thu_tu asc, id desc");  //DỊCH VỤ
?>
<div class="clearfix bao-left">
...
<div id="main_lockfixed">
    ...
    <div class="clearfix bao-left">
        <div class="title-left"><?=_thongketruycap?></div>
        <div class="ar_left">
