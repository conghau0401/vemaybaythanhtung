<?php
	...
	else if($source=="tin-tuc" || $source=="about" || $source=="dichvu" || $source=="gallery" || $source=="san-pham" || $source=="lien-he" || $source=="video" || $source=="gio-hang") {
	...
	else $img_cn = URLPATH."templates/images/module/icon.png";	
