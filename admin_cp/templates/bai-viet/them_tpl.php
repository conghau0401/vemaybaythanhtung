...
<link rel="stylesheet" type="text/css" href="public/extra/bootstrap-datepicker/bootstrap-datepicker.js">
<ol class="breadcrumb">
		...
		<div class="ar_admin last">
			<table class="table table-bordered table-hover them_dt" style="border:none">
				...
				<tr>
					...
					<td class="td_right">
						<?php if($items[0]['hen_ngay']!= '0000-00-00'){ ?>
							...
							<input type="text" name="hen_ngay" id="mydate" class="input width400 width150 form-control" value="<?=date('d-m-Y', strtotime($items[0]['hen_ngay']))?>" >
						<?php } else { ?>
							<input type="text" name="hen_ngay" class="input width400 width150 form-control datepicker">
						<?php } ?>
