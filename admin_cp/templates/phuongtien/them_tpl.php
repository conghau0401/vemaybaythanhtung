...
<div class="col-xs-12">
<form name="frm" method="post" action="index.php?p=phuongtien&a=save&id=<?=@$_REQUEST['id']?>&page=<?=@$_REQUEST['page']?>&loaitin=<?=@$_GET['loaitin']?>" enctype="multipart/form-data">
	...
	<div id="myTabContent" class="tab-content">
		...
		<table class="table table-bordered table-hover them_dt" style="border:none">
			...
			<tr>
				...
				<td class="td_right">
					<input type="button" value="Thoát" onclick="javascript:window.location='index.php?p=phuongtien&a=man'" class="btn btn-primary" />
				</td>
			</tr>
		</table>
		</div>
