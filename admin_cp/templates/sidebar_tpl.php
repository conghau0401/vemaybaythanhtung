...
<div class="panel panel-default">
    ...
    <ul id="menu" class="list-group">
        ...
        <li class="list-group-item <?php if($_GET['p'] == 'category' || $_GET['p'] == 'phuongtien' || $_GET['p'] == 'san-pham' || $_GET['p'] == 'bat-dong-san' || $_GET['p'] == 'catalogue' || $_GET['p'] == 'bai-viet' ) echo "active" ?>">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item <?php if($_GET['p'] == 'san-pham') echo "active"?>">
                    <a href="?p=san-pham&a=man"><i class="glyphicon glyphicon-chevron-right"></i> <span>Quản lý tour</span></a>
                </li>
                <?php } ?>
                ...
                <?php
                    if($d->checkUserPermission($_SESSION['id_user'],'phuongtien') > 0 || $_SESSION['is_admin'] == 1 ){
                ?>
                <li class="list-group-item <?php if($_GET['p'] == 'phuongtien') echo "active"?>">
                    <a href="?p=phuongtien&a=man"><i class="glyphicon glyphicon-chevron-right"></i> <span>Phương tiện</span></a>
                </li>
                <?php } ?>
