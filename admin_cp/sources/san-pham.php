...
function luudulieu(){
	...
	if($id != '')
	{
		...
		$str_id_loai = implode("," , $_POST['id_loai']);
		$data['id_loai'] = $str_id_loai;
		...
		$data['ngay'] = $d->clear(addslashes($_POST['ngay']));
		$data['dem'] = $d->clear(addslashes($_POST['dem']));

		$data['khuyen_mai'] = $d->clear(addslashes($_POST['khuyen_mai']));
		$data['gia'] = $d->clear(addslashes($_POST['gia']));
		$data['gia_treem'] = $d->clear(addslashes($_POST['gia_treem']));
		$data['gia_embe'] = $d->clear(addslashes($_POST['gia_embe']));
		$data['khoihanh_vn'] = $d->clear(addslashes($_POST['khoihanh_vn']));
		$data['khoihanh_us'] = $d->clear(addslashes($_POST['khoihanh_us']));

		// $data['states'] = $d->clear(addslashes($_POST['states']));
		$phuongtien = implode("," , $_POST['phuongtien']);
		$data['phuongtien'] = $phuongtien;


		$data['thong_tin_vn'] = $d->clear(addslashes($_POST['thong_tin_vn']));
		$data['thong_tin_us'] = $d->clear(addslashes($_POST['thong_tin_us']));
		$data['chinhsach_vn'] = $d->clear(addslashes($_POST['chinhsach_vn']));
		$data['chinhsach_us'] = $d->clear(addslashes($_POST['chinhsach_us']));
