...
<body id="login-body">
    <div class="login-header">
        <div class="alert alert-success alert-custom">
            ...
            <div class="huong-dan">
                <ul>
                    <li>Gửi yêu cầu vào email: <span class="red">conghau0401@gmail.com</span></li>
                    <li>Gọi số Hotline HTKH: <span class="red">0978.192.307</span></li>
                </ul>
            </div>
        </div>
    </div>
...
<div id="login-copyright"> <a href="https://websitegiatot.vn/" rel="nofollow" target="_blank" title="Thiết kế website: websitegiatot.vn">Thiết kế website: websitegiatot.vn</a> </div>
